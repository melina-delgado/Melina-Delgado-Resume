...
\begin{resume}
  ...
  Manage of the \textit{Vesta} application servicing the Yale housing lottery and room draw \smallskip{\href{yale.githost.io/sdmp/rails/vesta}{yale.githost.io/sdmp/rails/vesta}}. 
  \begin{itemize}
  ...
  Advised 60 incoming low-income, first-generation students. Hosted seminars by Yale professors, organized first-gen alumni events, and aided students' transition between high school and \smallskip{Yale University.} \\
  \textbf{Online Experiences for Yale Scholars} \textit{Math Tutor and Mentor}
  Developed lesson plans for weekly maths and economics lectures for a 5-6 person class of incoming Yale \smallskip{students.}
